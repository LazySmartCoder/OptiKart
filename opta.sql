...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(9,'OptiKartPortal','blog'),(10,'OptiKartPortal','cartitem'),(12,'OptiKartPortal','eyenumber'),(7,'OptiKartPortal','newsmail'),(11,'OptiKartPortal','orderstatus'),(8,'OptiKartPortal','product'),(6,'sessions','session');
...
--
-- Table structure for table `optikartportal_eyenumber`
--

DROP TABLE IF EXISTS `optikartportal_eyenumber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `optikartportal_eyenumber` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `Right` varchar(10) NOT NULL,
  `Left` varchar(10) NOT NULL,
  `User_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `OptiKartPortal_eyenumber_User_id_38a11b86_fk_auth_user_id` (`User_id`),
  CONSTRAINT `OptiKartPortal_eyenumber_User_id_38a11b86_fk_auth_user_id` FOREIGN KEY (`User_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `optikartportal_eyenumber`
--

LOCK TABLES `optikartportal_eyenumber` WRITE;
/*!40000 ALTER TABLE `optikartportal_eyenumber` DISABLE KEYS */;
/*!40000 ALTER TABLE `optikartportal_eyenumber` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `optikartportal_orderstatus` VALUES (84,'9',13),(85,'3',13);
...
-- Dump completed on 2023-08-20 18:58:03
